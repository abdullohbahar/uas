                        ...
                        <div class="card-header">
                            <div class="row justify-content-end">
                                ...
                                <div class="col-0 mr-2">
                                    <button data-toggle="modal" data-target="#addModal" class="btn btn-success">Tambah Kasir <i class="fas fa-plus"></i></button>
                                </div>
                            </div>
                        </div>
                        <!-- /.card-header -->
...
<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?= base_url('kasir'); ?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="modal fade" id="editModal<?= $m['id_admin']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="<?= base_url('kasir/ubahAdmin'); ?>" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
